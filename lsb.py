...
for filename in os.listdir('imageSet/'):
    ...
    if lsbBasicEmbed.lsbBasic(filename, embedRate, message, cv, queue) and (readLsbBasic.readLsbBasic(filename, embedRate, cv, queue, stegoFunctions) == message):
    ...
    if lsbEdgeEmbed.lsbEdge(filename, embedRateEdges, messageEdges, lowThreshold, thresholdRatio, cv, queue, copy, stegoFunctions):
        # readLsbEdge.readLsbEdge(filename, embedRateEdges, lowThreshold, thresholdRatio, cv, queue, copy, stegoFunctions)
